...
_LEDGERS: dict[str, dict[str, Any]] = {
    "ko-KR": {
        ...
        "ingredients": ["아미노산 유래 세정 성분", "판테놀", "보습 복합체", "세라마이드", "콜레스테롤"],
        ...
        "links": [
            ...
            },
            {
                ...
                "sentence": (
                    "보습 복합체 캡슐 속 세라마이드, 지방산, 콜레스테롤로 구성된 피부 장벽 핵심 성분이 "
        ...
        "cases": {
            ...
            "linked constituent": (
                "보습 복합체 캡슐 속 세라마이드, 지방산, 콜레스테롤이 건조하고 민감한 피부에 보습을 전달합니다."
            ),
        },
    ...
    "en-US": {
        ...
        "ingredients": ["amino acid derived cleansing ingredient", "Panthenol", "Moisture Complex", "Ceramide", "Cholesterol"],
        "benefits": [
        ...
        "links": [
            ...
            {
                "ingredient": "Moisture Complex",
                "benefit": "moisture for dry and sensitive skin",
                "sentence": (
                    "Moisture Complex capsules are built from Ceramide, fatty acid and Cholesterol, a core skin barrier "
...
_BOUNDARY: dict[str, dict[str, Any]] = {
    "ko-KR": {
        ...
        # 베타에는 링크가 없고, 보습 복합체 링크의 근거 문장은 다른 이름(베타인)을 부른다.
        "fragment name": {
            "ingredients": ["베타", "보습 복합체"],
            "links": [
                {
                    "ingredient": "보습 복합체",
                    "benefit": "보습",
                    "sentence": "보습 복합체는 세라마이드와 베타인으로 구성되어 피부에 보습을 전달합니다.",
                }
            ],
            "claim": "베타가 피부에 보습을 전달합니다.",
        },
    ...
    "en-US": {
        ...
        "fragment name": {
            "ingredients": ["Beta", "Moisture Complex"],
            "links": [
                {
                    "ingredient": "Moisture Complex",
                    "benefit": "moisture",
                    "sentence": "Moisture Complex is built from Ceramide and Betaine and delivers moisture to skin.",
                }
            ],
            "claim": "Beta delivers moisture to skin.",
        },
