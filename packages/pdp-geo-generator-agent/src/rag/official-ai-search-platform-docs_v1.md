...
This section governs JSON-LD schema graph eligibility and validation constraints for `Product`, `Offer`, variant, review, and rating markup — apply it whenever schema fields are generated or updated.
