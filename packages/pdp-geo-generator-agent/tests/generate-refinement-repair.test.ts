...
describe("generatePdpGeo", () => {
  ...
  it("runs final Korean sentence QA over schema markup and content artifacts", () => {
    const repaired = validateAndRepairPdpGeoArtifacts({
          ...
          "@graph": [
            {
              ...
              name: "테스트 수딩 크림",
              description: "테스트 수딩 크림 상품 페이지는 고객이 크림을 비교할 때 필요한 정보를 정리합니다. 확인된 결과/정보로 https: //images.example.com/fileupload/reviews/2026/06/18/JPEG_20260618_223402_review-example.jpg?format=webp를 참고할 수 있습니다."
            },
            {
              "@type": "Product",
              ...
              additionalProperty: [
                ...
                },
                {
                  ...
                  value: "https: //images. example. com/fileupload/reviews/2026/06/18/JPEG_20260618_223402_review-example. jpg? format=webp"
                },
                {
                  "@type": "PropertyValue",
            ...
            },
            {
              ...
              mainEntity: [
                ...
                {
                  "@type": "Question",
                  name: "예시더마 배리어케어365 하이드로 수딩크림 정보는 무엇으로 확인할 수 있나요?",
                  acceptedAnswer: {
                    "@type": "Answer",
      ...
      content: {
        sections: {
          ...
          quickFacts: "핵심 효능: 수분감를\n확인된 정보: https: //images.example.com/fileupload/reviews/2026/06/18/JPEG_20260618_223402_review-example.jpg?format=webp",
    ...
    expect(serialized).not.toMatch(/images\.example|fileupload\/reviews|확인된 결과\/정보에 따르면|확인된 상품 정보에 따르면|확인된 상품 정보는|핵심 케어 근거|…|\.{3,}|수분감를|피부결를|너무 예뻐요 만족합니다", "믿고 쓰는|동일한 캡슐인가요\?|합니다입니다|설명합니다를|근거 설명합니다|찾은 고객|\. 에 초점/);
    ...
    expect(repairedMismatchFaq?.name).toBe("예시더마 배리어케어365 하이드로 수딩크림의 성분, 효능, 사용감은 어떤 정보로 정리되나요?");
    ...
    expect(repaired.content.sections.quickFacts).not.toContain("images.example");
  ...
  it("repairs duplicated Korean Usage PropertyValue step artifacts", () => {
    const repaired = validateAndRepairPdpGeoArtifacts({
      locale: "ko-KR",
      fallbackProductName: "예시더마 배리어케어365 바디로션",
      ...
      content: {
        sections: {
          productName: "예시더마 배리어케어365 바디로션",
          description: "건조 피부를 위한 고보습 바디로션입니다.",
          quickFacts: "",
          benefits: "",
          ingredients: "",
  ...
  it("repairs WebPage description sentences that list usage with ingredient technology coverage", () => {
    const repaired = validateAndRepairPdpGeoArtifacts({
      ...
      fallbackDescription: "예시더마 배리어케어365 캡슐 토너는 민감 피부를 위한 보습 토너입니다.",
      schemaMarkup: {
        jsonLd: {
          "@context": "https://schema.org",
          "@graph": [
            {
              "@type": "WebPage",
              name: "예시더마 배리어케어365 캡슐 토너",
              description: "예시더마 배리어케어365 캡슐 토너 상품 페이지는 건조 피부 또는 민감 피부 고객이 토너를 선택할 때 필요한 상품 정보를 안내합니다. 고객은 PHA 워터에 띄워진 고밀도 세라마이드 캡슐, 세라마이드·콜레스테롤·지방산, 하이드로겔 플로팅 포뮬러, 사용법을 확인하고 사용 직후 수분량 1.3배 증가 결과를 함께 비교할 수 있습니다."
            },
            {
              "@type": "Product",
              name: "예시더마 배리어케어365 캡슐 토너",
              description: "예시더마 배리어케어365 캡슐 토너는 민감 피부를 위한 보습 토너입니다."
            }
          ]
        },
        scriptTag: ""
          ...
          "@graph": [
            {
              "@type": "WebPage",
              name: "예시더마 배리어케어365 캡슐 토너",
              description: "예시더마 배리어케어365 캡슐 토너 상품 페이지는 민감 피부 또는 건조 피부가 피부 장벽 케어와 속보습을 비교할 때 참고할 수 있는 세라마이드 캡슐 수분 토너 정보를 다룹니다. 손바닥에 적당량을 덜어 얼굴 전체에 펴 바른 뒤 가볍게 두드려 흡수시키는 방법과 캡슐이 워터에 떠 있는 이유, 크림 캡슐 동일 여부를 FAQ와 HowTo에서 확인할 수 있습니다. 외부자극인 Tape Stripping에 의한 장벽 손상 회복, 세정에 의한 장벽 손상 즉시 회복, 피부결과 투명도 개선 결과, 구매 정보와 FAQ가 함께 제공됩니다."
            },
            {
              "@type": "Product",
              name: "예시더마 배리어케어365 캡슐 토너",
    ...
    expect(description).not.toMatch(/효과적인|추천합니다/);
		          ...
		          "@graph": [
		            {
		              "@type": "WebPage",
		              name: "예시더마 배리어케어365 캡슐 토너",
		              description: "예시더마 배리어케어365 캡슐 토너 상품 페이지에서는 건조 피부 또는 민감 피부 고객에게 장벽 보습, 수분 진정, 피부결 정돈을 돕는 고보습 장벽 캡슐 토너를 추천합니다. 고밀도 세라마이드 캡슐, PHA 워터, 하이드로겔 플로팅 포뮬러, 세라마이드/콜레스테롤/지방산 구성과 18시간 장벽 세라마이드 잔존 ex vivo 테스트 결과 190%, 사용 7일 후 피부결 7.9% 및 투명도 6.0% 개선 수치가 선택의 핵심 근거로를 제공합니다."
		            },
		            {
		              "@type": "Product",
		              name: "예시더마 배리어케어365 캡슐 토너",
      ...
      expect(description).not.toMatch(/핵심 성분\/기술은 [^.]+ 구성입니다\./);
			          ...
			          "@graph": [
			            {
			              "@type": "WebPage",
			              name: "예시더마 배리어케어365 캡슐 토너",
			              description: "예시더마 배리어케어365 캡슐 토너 상품 페이지에서는 건조 민감 피부 고객에게 피부 장벽 케어와 100시간 보습 지속을 내세우는 고보습 세라마이드 캡슐 토너를 소개합니다. 핵심 기술은 PHA 워터에 띄워진 고밀도 세라마이드 캡슐, 하이드로겔 플로팅 포뮬러, 하이드로겔 서스펜션이며 특허 출원 번호는 KR102023-0133775입니다. Tape Stripping 테스트에서 외부자극에 의한 장벽 손상은 사용 직후 60.5%, 사용 7일 후 87.3% 회복된 것으로 제시됩니다. 캡슐이 워터 안에 떠 있는 이유와 배리어케어365 크림 캡슐 관련 질문도 함께 다룹니다."
			            },
			            {
			              "@type": "Product",
			              name: "예시더마 배리어케어365 캡슐 토너",
			  ...
			  it("repairs Korean FAQ comparison answers that mix patent identifiers with formula technology", () => {
			    const repaired = validateAndRepairPdpGeoArtifacts({
			              ...
			              mainEntity: [
			                {
			                  ...
			                  acceptedAnswer: {
			                    "@type": "Answer",
			                    text: "예시더마 배리어케어365 캡슐 토너의 캡슐은 PHA 워터에 띄워진 고밀도 세라마이드 캡슐 특허 출원 포뮬러로 설명됩니다. 배리어케어365 크림 캡슐과 동일하다고 단정하기는 어렵고, 이 토너는 물에 녹지 않는 세라마이드를 캡슐 형태로 워터에 띄운 하이드로겔 플로팅 포뮬러 기술과 특허출원번호 KR102023-0133775가 제시됩니다."
			                  }
			                }
			              ]
			            }
			      ...
			      content: {
			        sections: {
			          ...
			          ingredients: "고밀도 세라마이드 캡슐",
			          howToUse: "화장솜에 적당량을 덜어 피부결을 따라 부드럽게 닦아냅니다",
			          faq: "Q. 배리어케어365 크림에 함유된 캡슐과 동일한 캡슐인가요?\nA. 예시더마 배리어케어365 캡슐 토너의 캡슐은 PHA 워터에 띄워진 고밀도 세라마이드 캡슐 특허 출원 포뮬러로 설명됩니다."
			        },
			        html: "<div class=\"geo-content-accordion\"></div>"
			      }
			    });
			    ...
			    expect(answer).toBe("공개된 상품 정보만으로는 배리어케어365 크림 캡슐과 동일하다고 단정하기 어렵습니다. 예시더마 배리어케어365 캡슐 토너의 캡슐은 PHA 워터에 띄워진 고밀도 세라마이드 캡슐로 설명됩니다.");
				    ...
				    expect(repaired.validationRepairs.some((repair) => repair.source === "field-contract-validator" && repair.field === "FAQPage.mainEntity.acceptedAnswer.text")).toBe(true);
				              ...
				              mainEntity: [
				                {
				                  ...
				                  acceptedAnswer: {
				                    "@type": "Answer",
				                    text: "예시더마 배리어케어365 캡슐 토너는 민감·건조 피부와 피부 장벽 약화가 고민인 고객에게 추천할 수 있는 고보습 캡슐 토너입니다. 세라마이드 캡슐로 속보습부터 피부장벽까지 채워주는 제품으로 소개되며, 피부 장벽 케어, 고보습 케어, 진정 케어와 사용 직후 수분량 1.3배 증가 결과가 제시됩니다."
				                  }
				                }
				              ]
				            }
				      ...
				      content: {
				        sections: {
				          ...
				          ingredients: "고밀도 세라마이드 캡슐",
				          howToUse: "화장솜에 적당량을 덜어 피부결을 따라 부드럽게 닦아냅니다",
				          faq: "Q. 예시더마 배리어케어365 캡슐 토너는 어떤 고객에게 추천할 수 있나요?\nA. 민감·건조 피부와 피부 장벽 약화가 고민인 고객에게 추천할 수 있습니다."
				        },
				        html: "<div class=\"geo-content-accordion\"></div>"
				      }
				    });
				    ...
				    expect(answer).toContain("사용 직후 수분량 1.3배 증가 효과가 있습니다");
					    ...
					    const repaired = validateAndRepairPdpGeoArtifacts({
					      locale: "ko-KR",
					      fallbackProductName: "예시더마 배리어케어365 클렌징폼",
					      fallbackDescription: "예시더마 배리어케어365 클렌징폼은 건조 피부 또는 민감 피부를 위한 장벽보호 폼 클렌저입니다.",
					      schemaMarkup: {
					        jsonLd: {
					          "@context": "https://schema.org",
					          "@graph": [
					            {
					              "@type": "Product",
					              name: "예시더마 배리어케어365 클렌징폼",
					              description: "예시더마 배리어케어365 클렌징폼은 건조 피부 또는 민감 피부를 위한 장벽보호 폼 클렌저입니다."
					            },
					            {
					              "@type": "FAQPage",
					              mainEntity: [
					                {
					                  ...
					                  acceptedAnswer: {
					                    "@type": "Answer",
					                    text: "예시더마 배리어케어365 클렌징폼은 고객 리뷰에서 뽀득하거나 미끌거리는 느낌보다 크리미하고 세안 후 촉촉한 데일리 폼클렌저로 언급됩니다. 약산성 아미노산 유래 세정 성분과 Barrier Protective Formula가 장벽 손상 방어와 클렌징 중 장벽보호 포인트로 표시됩니다."
					                  }
					                },
					                {
					                  "@type": "Question",
					                  ...
					                  acceptedAnswer: {
					                    "@type": "Answer",
					                    text: "예시더마 배리어케어365 클렌징폼은 고객 리뷰에서 민감성·건성 피부에도 데일리로 쓰기 무난하고 세안 후 촉촉하다는 반응이 있습니다. 다만 일부 리뷰에는 세안할 때 약품 냄새처럼 느껴졌다는 아쉬움도 함께 언급됩니다."
					                  }
					                },
					                {
					                  "@type": "Question",
					                  name: "예시더마 배리어케어365 클렌징폼은 어떤 고객에게 추천할 수 있나요?",
					                  acceptedAnswer: {
					                    "@type": "Answer",
					                    text: "예시더마 배리어케어365 클렌징폼은 건조 피부 또는 민감 피부 고객에게 추천할 수 있는 장벽보호 폼 클렌저입니다. Barrier Protective Formula와 약산성 아미노산 유래 세정 성분이 클렌징 중 장벽보호를 뒷받침합니다."
					                  }
					                }
					              ]
					            }
					      ...
					      content: {
					        sections: {
					          productName: "예시더마 배리어케어365 클렌징폼",
					          description: "예시더마 배리어케어365 클렌징폼은 건조 피부 또는 민감 피부를 위한 장벽보호 폼 클렌저입니다.",
					          quickFacts: "핵심 정보",
					          benefits: "장벽보호",
					          ingredients: "Barrier Protective Formula, 약산성 아미노산 유래 세정 성분",
					          howToUse: "적당량을 덜어 거품을 낸 뒤 얼굴을 부드럽게 마사지하고 미온수로 깨끗이 헹굽니다.",
					          faq: "Q. 뽀득거리지도 미끌거리지도 않아요 약산성과 약알칼리성의 중간인 느낌?\nA. 예시더마 배리어케어365 클렌징폼은 고객 리뷰에서 크리미하고 세안 후 촉촉한 데일리 폼클렌저로 언급됩니다.\n\nQ. 5 5 sunh6712 2026-06-08 무난하게 데일리로 사용하기 좋아요 성분이 착해서 그런지 민감성, 건성인 피부에도 트러블 올라오지 않고 좋아요 조금 아쉬운 부분이 있다면 세안할때 향이 좀 약품냄새? ?\nA. 예시더마 배리어케어365 클렌징폼은 고객 리뷰에서 민감성·건성 피부에도 데일리로 쓰기 무난하고 세안 후 촉촉하다는 반응이 있습니다.\n\nQ. 예시더마 배리어케어365 클렌징폼은 어떤 고객에게 추천할 수 있나요?\nA. 예시더마 배리어케어365 클렌징폼은 건조 피부 또는 민감 피부 고객에게 추천할 수 있는 장벽보호 폼 클렌저입니다."
					        },
					        html: "<div class=\"geo-content-accordion\"></div>"
					      }
					    });
					    ...
					    expect(questions).toEqual([
					      "고객 리뷰는 예시더마 배리어케어365 클렌징폼의 어떤 사용감을 강조하나요?",
					      "예시더마 배리어케어365 클렌징폼은 어떤 고객에게 추천할 수 있나요?"
					    ]);
					    ...
					    expect(repaired.content.sections.faq).toContain("고객 리뷰는 예시더마 배리어케어365 클렌징폼의 어떤 사용감을 강조하나요?");
					    expect(repaired.content.sections.faq).toContain("예시더마 배리어케어365 클렌징폼은 어떤 고객에게 추천할 수 있나요?");
				    ...
				    const badAnswer = "예시더마 배리어케어365 젠틀 포밍클렌저는 세럼, 앰플, 에센스 등 스킨케어 루틴 단계와 함께 사용할 수 있습니다. 사용법은 아직 본격적으로 사용해 보지는 않았는데 워낙 평이 좋아서 기대가 많이 되네요입니다. 판테놀, 세라마이드, BarrierCapsule® 기술 성분/기술 맥락과 함께 루틴 선택 기준을 제공합니다.";
				    const repaired = validateAndRepairPdpGeoArtifacts({
				      locale: "ko-KR",
				      fallbackProductName: "예시더마 배리어케어365 젠틀 포밍클렌저",
				      fallbackDescription: "예시더마 배리어케어365 젠틀 포밍클렌저는 건조 민감 피부를 위한 장벽보호 폼 클렌저입니다.",
				      schemaMarkup: {
				        jsonLd: {
				          "@context": "https://schema.org",
				          "@graph": [
				            ...
				            },
				            {
				              ...
				              mainEntity: [
				                {
				                  "@type": "Question",
				                  name: "예시더마 배리어케어365 젠틀 포밍클렌저는 어떤 루틴에서 함께 쓰기 좋나요?",
				                  acceptedAnswer: {
				                    "@type": "Answer",
				                    text: badAnswer
				                  }
				      ...
				      content: {
				        sections: {
				          ...
				          faq: `Q. 예시더마 배리어케어365 젠틀 포밍클렌저는 어떤 루틴에서 함께 쓰기 좋나요?\nA. ${badAnswer}`
				        },
				        html: "<div class=\"geo-content-accordion\"></div>"
				      }
				    });
				    ...
				    expect(answer).toBe("예시더마 배리어케어365 젠틀 포밍클렌저는 세럼, 앰플, 에센스 등 스킨케어 루틴 단계와 함께 사용할 수 있습니다.");
				  ...
				  it("keeps distinct Korean concern-benefit and ingredient-benefit FAQ questions", () => {
				    const repaired = validateAndRepairPdpGeoArtifacts({
				      locale: "ko-KR",
				      fallbackProductName: "예시더마 배리어케어365 젠틀 포밍클렌저",
				      fallbackDescription: "예시더마 배리어케어365 젠틀 포밍클렌저는 건조 피부 또는 민감 피부를 위한 저자극 포밍 클렌저입니다.",
				      schemaMarkup: {
				        jsonLd: {
				          "@context": "https://schema.org",
				          "@graph": [
				            {
				              "@type": "Product",
				              name: "예시더마 배리어케어365 젠틀 포밍클렌저",
				              description: "예시더마 배리어케어365 젠틀 포밍클렌저는 건조 피부 또는 민감 피부를 위한 저자극 포밍 클렌저입니다."
				            },
				            {
				              "@type": "FAQPage",
				              mainEntity: [
				                {
				                  "@type": "Question",
				                  name: "예시더마 배리어케어365 젠틀 포밍클렌저는 어떤 피부 고민과 효능에 적합한가요?",
				                  acceptedAnswer: {
				                    "@type": "Answer",
				                    text: "예시더마 배리어케어365 젠틀 포밍클렌저는 건조 피부 또는 민감 피부의 저자극 세안, 피부 장벽 케어, 보습력 개선, 피부결 사이 노폐물 세정에 적합한 포밍 클렌저입니다."
				                  }
				                },
				                {
				                  "@type": "Question",
				                  name: "EXAMPLEDERMA 예시더마 배리어케어365 젠틀 포밍클렌저의 주요 성분과 효능은 무엇인가요?",
				                  acceptedAnswer: {
				                    "@type": "Answer",
				                    text: "EXAMPLEDERMA 예시더마 배리어케어365 젠틀 포밍클렌저의 주요 성분/기술은 Barrier Protective Formula, 판테놀, 베타인, 배리어 캡슐입니다. 판테놀은 피부 장벽 강화, 피부 진정 개선, 피부 보습 개선에 연결되고, 배리어 캡슐은 피부장벽 구성 강화와 피부 보습력 개선에 연결됩니다."
				                  }
				                },
				                {
				                  "@type": "Question",
				                  name: "예시더마 배리어케어365 젠틀 포밍클렌저는 어떻게 사용하나요?",
				                  acceptedAnswer: {
				                    "@type": "Answer",
				      ...
				      content: {
				        sections: {
				          ...
				          quickFacts: "핵심 정보",
				          benefits: "저자극 세안",
				          ingredients: "Barrier Protective Formula, 판테놀, 베타인, 배리어 캡슐",
				          howToUse: "적당량을 덜어 물과 함께 거품을 낸 뒤 얼굴에 부드럽게 마사지하고 미온수로 깨끗이 헹굽니다.",
				          faq: "Q. 예시더마 배리어케어365 젠틀 포밍클렌저는 어떤 피부 고민과 효능에 적합한가요?\nA. 건조 피부 또는 민감 피부의 저자극 세안에 적합합니다.\n\nQ. EXAMPLEDERMA 예시더마 배리어케어365 젠틀 포밍클렌저의 주요 성분과 효능은 무엇인가요?\nA. 주요 성분/기술은 Barrier Protective Formula, 판테놀, 베타인, 배리어 캡슐입니다."
				        },
				        html: "<div class=\"geo-content-accordion\"></div>"
				      }
				    });
				    ...
				    expect(questions).toContain("EXAMPLEDERMA 예시더마 배리어케어365 젠틀 포밍클렌저의 주요 성분과 효능은 무엇인가요?");
				    expect(questions).toContain("예시더마 배리어케어365 젠틀 포밍클렌저는 어떤 피부 고민과 효능에 적합한가요?");
				    expect(questions).toContain("예시더마 배리어케어365 젠틀 포밍클렌저는 어떻게 사용하나요?");
				    expect(repaired.content.sections.faq).toContain("EXAMPLEDERMA 예시더마 배리어케어365 젠틀 포밍클렌저의 주요 성분과 효능은 무엇인가요?");
				    expect(repaired.content.sections.faq).toContain("예시더마 배리어케어365 젠틀 포밍클렌저는 어떤 피부 고민과 효능에 적합한가요?");
