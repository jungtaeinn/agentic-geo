...
export const exampleluxeBotanicalGinsengSerum: PdpProductSignal = {
...
export const exampleluxeEssentialCareActivatingSerum: PdpProductSignal = {
...
export const exampledermaBarrierCareCapsuleToner: PdpProductSignal = {
...
export const exampledermaBarrierCareCreamMist: PdpProductSignal = {
