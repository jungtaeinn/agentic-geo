    ...
    const timerId = window.setTimeout(() => {
      ...
      void requestRagProfile()
        .then((settings) => {
          ...
          setRagMessage("packages/pdp-extractor-agent의 RAG 프로필을 불러왔습니다.");
        })
        .catch((error: unknown) => {
        ...
        : [
            {
              id: createId(),
              role: "tool" as const,
              command: "pdp-extractor-agent 준비됨",
              body: "packages/pdp-extractor-agent의 독립 에이전트와 REST 어댑터를 사용합니다."
            }
          ]),
      {
        id: createId(),
                  ...
                  <div className={`connectionBanner ${connectionStatus}`} role={connectionStatus === "error" ? "alert" : "status"}>
                    ...
                    <div className="connectionCopy">
                      <div className="connectionHeader">
                        ...
                        <em>{connectionStatusLabel(connectionStatus)}</em>
                      </div>
                  ...
                  {(["mock", "openai", "gemini", "azure-openai", "aistudio"] satisfies ProviderId[]).map((provider) => (
                    ...
                    >
                      <span className="providerOptionText">
                        ...
                        <em>{providerDescriptions[provider]}</em>
                      </span>
                      <Circle size={14} />
                    </button>
                  ))}
