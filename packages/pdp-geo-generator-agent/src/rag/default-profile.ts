...
export const defaultPdpGeoGeneratorAnalysisPrompt = [
  ...
  "Product.description structure: product introduction/type -> target customer and concrete concern/CEP -> ingredient/technology composition -> supported finished-product benefit/effect and compact evidence/test context -> attributed positive or neutral review summary last. Keep usage in Usage/HowTo.",
  ...
  "Separate schema descriptions by entity role: WebPage.description introduces the product page and source-backed brand, then gives a compact but concrete summary of supported target/formula/benefit information and remaining page coverage; Product.description follows the five-part connected product narrative without page-resource language. Brand history or science requires separate current-source brand evidence. Keep detailed methods, disclosures, caveats, and raw metrics in dedicated properties or evidence FAQ unless one natural measured-outcome sentence directly answers the concern.",
  ...
  documents: [
    {
      ...
      content: [
        ...
        "- Keep `WebPage.description` and `Product.description` distinct by entity role. WebPage is a compact but concrete product-page, brand, supported-information, and actual page-scope summary. Product follows product introduction/type, target customer/concern, ingredient/technology composition, supported benefit/effect/evidence, then an attributed review summary last.",
    ...
    },
    {
      ...
      content: [
        ...
        "",
        "- Prefer product introduction/type -> target customer/concern -> ingredient/technology composition -> supported finished-product benefit/effect/evidence -> attributed positive/neutral review pattern last, omitting missing nodes without filling them from general category knowledge.",
        ...
        "- Product.description: use product-specific CEPs in order: product introduction/type, target customer and concern, ingredient composition, supported benefit/effect/evidence, then an attributed representative review preference.",
    ...
    },
    {
      ...
      content: [
        ...
        "",
        "- Compose Product.description from product introduction/type, target customer and concrete concern, ingredient or technology composition, supported finished-product benefit/effect and compact evidence/test context, then attributed positive or neutral review context last.",
        ...
        "- `Product.description` should explain what the product is, who it is for and which concern matters, which ingredients/technologies compose it, which finished-product benefit/effect is supported, and what attributed positive or neutral experience customers mention.",
        "",
