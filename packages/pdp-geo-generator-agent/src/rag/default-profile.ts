  ...
  documents: [
    ...
    },
    {
      ...
      content: [
        ...
        "- CEPs must be grounded in product facts, customer-customer review language, source category information, or approved brand positioning.",
        "",
        "## CEP Dimensions",
        "",
    ...
    },
    {
      ...
      content: [
        ...
        "",
        "- Compose descriptions from target customer, core benefit, ingredient or technology, usage context, and source-supported or review-backed detail.",
        ...
        "",
        "- Do not reuse the same text for WebPage.description and Product.description; page descriptions should explain page coverage while naming benefits, ingredients, customer review language, and reported results. Product descriptions should explain who the product is for, what benefits and major ingredients it has, what representative customer reviews say, how it can be used, and which supported result details are available.",
    ...
    },
    {
      ...
      content: [
        ...
        "- Review and customer language: use repeated customer review language to shape customer-facing questions, preference phrases, and experience summaries.",
