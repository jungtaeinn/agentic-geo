...
export const defaultPdpGeoGeneratorAnalysisPrompt = [
  ...
  "Description structure: product identity/type + target customer and concrete concern/CEP + ingredient/technology relevance + supported benefit/effect + concise positive or neutral review pattern.",
  ...
  "Separate schema descriptions by entity role without making either description superficial: WebPage.description should introduce the product page and follow product -> target concern -> ingredient-to-benefit explanation -> review summary before optional page coverage, while Product.description should follow the same buyer reasoning without page-resource language. Introduce the full product name once per product narrative and connect subsequent clauses without mechanically repeating it. Keep standalone certifications, detailed test methods, disclosures, caveats, and raw metrics in dedicated properties or evidence FAQ unless one natural measured-outcome sentence directly answers the concern.",
  ...
  "HowTo is optional and requires a source-backed ordered procedure with at least two distinct actionable steps. Keep a single instruction or unordered usage note visible as usage content without HowTo markup.",
  ...
  documents: [
    {
      ...
      content: [
        ...
        "- Keep `WebPage.description` and `Product.description` distinct and detailed. Both should follow product identity/type, target customer and concern, ingredient/technology relevance, supported benefit/effect, and concise review pattern. Keep WebPage page-level and Product entity-level; route detailed methods, caveats, certifications, and raw metric strings to dedicated properties or evidence FAQ.",
        ...
        "- Use `HowTo.step` only for an explicit ordered procedure with at least two distinct source-backed actions. Keep a single instruction or unordered usage note in `additionalProperty` and visible HTML without HowTo markup.",
    ...
    },
    {
      ...
      content: [
        ...
        "9. Prioritize candidates by source support, causal completeness, specificity, review repetition, commerce usefulness, locale fit, and schema field usefulness.",
        "",
        "## Causal Path Completeness",
        "",
        "- Prefer product identity/type -> target customer/concern -> ingredient/technology -> supported benefit/effect -> official measurement -> positive/neutral review pattern, omitting missing nodes without filling them from general category knowledge.",
        ...
        "- Product.description: use product-specific CEPs in order: product identity/type, target customer and concern, ingredient need and why it matters, benefit/effect, then a concise representative review preference.",
        ...
        "- HowTo.step: use a routine or occasion CEP only when the source provides an ordered procedure with at least two distinct actions.",
        "",
        "## Partial Update Query Planning",
        "",
    ...
    },
    {
      ...
      content: [
        ...
        "",
        "- Compose descriptions from product identity/type, target customer and concrete concern, ingredient or technology relevance, supported benefit/effect, and concise positive or neutral review context.",
        ...
        "- `WebPage.description` should introduce the product page, then connect product identity, target concern, ingredient/technology relevance, supported benefit/effect, and a concise review pattern before optional page coverage.",
        "- `Product.description` should explain what the product is, who it is for and which concern matters, why the ingredient/technology is relevant, which benefit/effect is supported, and what positive or neutral experience customers repeatedly mention.",
        "",
        "## Entity and Intent Rules",
        "",
        "- Do not reuse the same text for WebPage.description and Product.description; both should follow product -> target concern -> ingredient-to-benefit explanation -> review summary, while page descriptions retain a page-level introduction or coverage sentence. Keep standalone certification/test/disclosure wording and raw metric strings out of descriptions.",
        ...
        "- Keep ordinary usage copy visible, but create HowTo only from a source-backed ordered procedure with at least two distinct actions; remove source labels and deduplicate repeated steps.",
        "",
    ...
    },
    {
      ...
      content: [
        ...
        "- FAQ and HowTo answerability: FAQ has no minimum and requires a direct evidence-backed answer; HowTo requires an ordered source procedure with at least two distinct evidence-backed actions.",
