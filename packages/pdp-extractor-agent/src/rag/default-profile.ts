  ...
  documents: [
    ...
    },
    {
      ...
      content: [
        ...
        "- Sentence insights should preserve the source sentence or a compact source-backed clause. If one sentence links an ingredient/technology to outcomes, classify it by the strongest downstream field and keep related keywords together, for example ingredient keywords plus firmness/elasticity effect terms.",
